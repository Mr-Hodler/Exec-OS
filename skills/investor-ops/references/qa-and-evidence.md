...
If the evidence exists in Founder-OS but not yet in the room, mark the row **missing** and route a Sync request to investor-ops. Do not answer from memory or assumption.
...
- **missing:** no evidence; route to investor-ops (sync) or to the relevant Founder-OS skill (produce). Never bluff.
...
Deliver a status readout on demand: counts of answered / partial / missing / N/A by area, the top blockers (high-priority questions still missing evidence), and the route to close each. State readiness relative to the named DD scope, for example: "Financial DD 90 percent answered, 2 blockers (audited accounts, monthly cash flow); tech DD 60 percent, evidence sync pending from investor-ops."
