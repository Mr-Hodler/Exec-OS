...
The view is live: as investor-ops syncs updates, the recipient sees current versions. This is the preferred mode for an active process because it is current and fully logged.
